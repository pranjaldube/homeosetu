...
export const REMEDY_DICTIONARY: Record<string, RemedyInfo[]> = {
  ...
  "acon.": [
    {
      ...
      description:
        "Cough, croup: dry, hoarse, suffocating; Loud, rough. croaking; hard, ringing, whistling; on expiration (caust.)",
    },
  ],
  "acon-f.": [{ name: "Aconitum ferox", description: "Aconitum ferox" }],
  "acon-l.": [
    { name: "Aconitum lycotonum", description: "Aconitum lycotonum" },
  ],
  ...
  "agar-ph.": [
    { name: "Agaricus phalloides", description: "Agaricus phalloides" },
  ],
  ...
  "alst.": [
    { name: "Alstonia constricta", description: "Alstonia constricta" },
  ],
  ...
  "ambro.": [
    {
      name: "Ambrosia artemisiæ folia",
      description: "Ambrosia artemisiæ folia",
    },
  ],
  ...
  "am-c.": [
    { name: "Ammonium carbonicum", description: "Ammonium carbonicum" },
  ],
  "am-caust.": [
    { name: "Ammonium causticum", description: "Ammonium causticum" },
  ],
  "am-m.": [
    { name: "Ammonium muriaticum", description: "Ammonium muriaticum" },
  ],
  "amph.": [{ name: "Amphisbæna", description: "Amphisbæna" }],
  "amyg.": [
    { name: "Amygdalæ amaræ aqua", description: "Amygdalæ amaræ aqua" },
  ],
  "aml-n.": [{ name: "Amyl nitrite", description: "Amyl nitrite" }],
  "anac.": [
    { name: "Anacardium orientale", description: "Anacardium orientale" },
  ],
  "anac-oc.": [
    { name: "Anacardium occidentale", description: "Anacardium occidentale" },
  ],
  "anag.": [{ name: "Anagallis arvensis", description: "Anagallis arvensis" }],
  "anan.": [
    { name: "Anantherum muricatum", description: "Anantherum muricatum" },
  ],
  ...
  "ant-a.": [
    { name: "Antimonium arsenicosum", description: "Antimonium arsenicosum" },
  ],
  "ant-c.": [{ name: "Antimonium crudum", description: "Antimonium crudum" }],
  "ant-chl.": [
    { name: "Antimonium chloridum", description: "Antimonium chloridum" },
  ],
  "ant-ox.": [
    { name: "Antimonium oxydatum", description: "Antimonium oxydatum" },
  ],
  "ant-s.": [
    {
      name: "Antimonium sulph. auratum",
      description: "Antimonium sulph. auratum",
    },
  ],
  "ant-t.": [
    { name: "Antimonium tartaricum", description: "Antimonium tartaricum" },
  ],
  "aphis.": [
    { name: "Aphis chenopodii glauci", description: "Aphis chenopodii glauci" },
  ],
  ...
  "arg-mur.": [
    { name: "Argentum muriaticum", description: "Argentum muriaticum" },
  ],
  ...
  "arn.": [
    {
      name: "Arnica montana",
      description:
        "Conjunctival or retinal hemorrhage, with extravasation, from injuries or cough (Led., Nux-v,)",
    },
  ],
  ...
  "ars-h.": [
    {
      ...
      description: "Arsenicum hydrogenisatum",
    },
  ],
  "ars-i.": [{ name: "Arsenicum iodatum", description: "Arsenicum iodatum" }],
  "ars-m.": [
    { name: "Arsenicum metallicum", description: "Arsenicum metallicum" },
  ],
  "ars-s-f.": [
    {
      name: "Arsenicum sulphuratum flavum",
      description: "Arsenicum sulphuratum flavum",
    },
  ],
  "ars-s-r.": [
    {
      name: "Arsenicum sulphuratum rubrum",
      description: "Arsenicum sulphuratum rubrum",
    },
  ],
  ...
  "aspar.": [
    { name: "Asparagus officinalis", description: "Asparagus officinalis" },
  ],
  "astac.": [
    { name: "Astacus fluviatilis", description: "Astacus fluviatilis" },
  ],
  "aster.": [{ name: "Asterias rubens", description: "Asterias rubens" }],
  "atro.": [{ name: "Atropinum", description: "Atropinum" }],
  "atro-s.": [
    { name: "Atropia sulphurica", description: "Atropia sulphurica" },
  ],
  ...
  "aur-m-n.": [
    {
      ...
      description: "Aurum muriaticum natronatum",
    },
  ],
  ...
  "bac-dys.": [
    {
      name: "Bacillus Dysentrico, Dysentery Bacillus, Shigella Dysentriae",
      description:
        " In some children, diagnosed as suffering from congenital pyloric stenosis considerable success has followed the use of Bacillus Dysentrico Bach , which would suggest that in these cases the condition had been due to pyloric spasm rather than to congenital malformation, of the pylorus.",
    },
  ],
  "bac-faec.": [
    { name: "Bacillus Faecalis", description: "Bacillus Faecalis" },
  ],
  "bac-morg.": [
    {
      name: "Morgan Pure, Morgan bacillus, Morgan pure, Proteus morgani",
      description: "Morgan Pure, Morgan bacillus, Morgan pure, Proteus morgani",
    },
  ],
  "bac-morg-b.": [
    {
      name: "Morgan Bach",
      description:
        "Chronic congestion around the joints causes arthritic conditions, usually affecting the phalangeal or knee joint regions.",
    },
  ],
  "bac-morg-g.": [
    {
      name: "Morgan Gaertner",
      description: "Vertigo from High Blood Pressure",
    },
  ],
  "bac-mut.": [
    {
      name: "Bacillus Mutabile. Mutabile Bach",
      description: "Bacillus Mutabile. Mutabile Bach",
    },
  ],
  "bac-prot.": [
    {
      name: "Bacillus Proteus",
      description:
        'Further indication for the use of this nosode is disturbance of the peripheral nervous system, evidenced by spasm of the peripheral circulation, e. g. "dead fingers intermittent claudication in the circulation of the lower limbs ; anginal attacks due to spasm of the coronary capillaries.',
    },
  ],
  "bac-sev.": [
    {
      name: "Bacillus Seven",
      description:
        "Relaxed fibrous tissue, with tendency to the formation of rheumatic nodules",
    },
  ],
  "bac-syco.": [
    {
      name: "Sycotic co. bacillus. Sycotic bacillus. Bowel nosode",
      description: "Sycotic co. bacillus. Sycotic bacillus. Bowel nosode",
    },
  ],
  ...
  "bals.": [
    { name: "Balsamum peruvianum", description: "Balsamum peruvianum" },
  ],
  "bapt.": [{ name: "Baptisia tinctoria", description: "Baptisia tinctoria" }],
  "bart.": [
    {
      name: "Bartfelder (acid spring)",
      description: "Bartfelder (acid spring)",
    },
  ],
  ...
  "bar-c.": [
    {
      ...
      description:
        "Chronic cough in psoric children; enlarged tonsils or elongated uvula; agg. after cold (Alum.)",
    },
  ],
  ...
  "berb-aq.": [
    { name: "Berberis Aquifolium", description: "Berberis Aquifolium" },
  ],
  "bism.": [
    {
      name: "Bismuthum oxidum",
      description:
        "Cholera morbus and summer complaints, when vomiting predominates",
    },
  ],
  ...
  "both.": [
    { name: "Bothrops lanceolatus", description: "Bothrops lanceolatus" },
  ],
  "bov.": [{ name: "Bovista", description: "Bovista" }],
  "brach.": [
    { name: "Brachyglottis repens", description: "Brachyglottis repens" },
  ],
  "brom.": [{ name: "Bromium", description: "Bromium" }],
  "bruc.": [
    { name: "Brucea antidysenterica", description: "Brucea antidysenterica" },
  ],
  ...
  "cact.": [
    { name: "Cactus grandiflorus", description: "Cactus grandiflorus" },
  ],
  "cadm.": [
    { name: "Cadmium sulphuratum", description: "Cadmium sulphuratum" },
  ],
  ...
  "calc.": [
    {
      name: "Calc.,Bac., -Abdomen, DISTENDED: In fat scrofulous children, Calc. 6, 6h. Intercurrently, Bac 30, once a week.",
      description:
        "Calc.,Bac., -Abdomen, DISTENDED: In fat scrofulous children, Calc. 6, 6h. Intercurrently, Bac 30, once a week.",
    },
  ],
  "calc-caust.": [
    { name: "Calcarea caustica", description: "Calcarea caustica" },
  ],
  "calc-chlor.": [
    { name: "Calcarea Chlorinata", description: "Calcarea Chlorinata" },
  ],
  "calc-f.": [{ name: "Calcarea fluorata", description: "Calcarea fluorata" }],
  "calc-i.": [{ name: "Calcarea iodata", description: "Calcarea iodata" }],
  "calc-m.": [
    { name: "Calcarea Muriaticum", description: "Calcarea Muriaticum" },
  ],
  "calc-p.": [
    { name: "Calcarea phosphorica", description: "Calcarea phosphorica" },
  ],
  "calc-sil.": [
    { name: "Calcarea silicata", description: "Calcarea silicata" },
  ],
  "calc-s.": [
    { name: "Calcarea sulphurica", description: "Calcarea sulphurica" },
  ],

  "calen.": [
    { name: "Calendula officinalis", description: "Calendula officinalis" },
  ],
  "calli.": [
    { name: "Calliandra houstoni", description: "Calliandra houstoni" },
  ],
  "calo.": [
    { name: "Calotropis gigantea", description: "Calotropis gigantea" },
  ],
  "calt.": [{ name: "Caltha palustris", description: "Caltha palustris" }],
  "camph.": [
    { name: "Camphora officinarum", description: "Camphora officinarum" },
  ],
  ...
  "carb-h.": [
    {
      name: "Carboneum hydrogenisatun",
      description: "Carboneum hydrogenisatun",
    },
  ],
  "carbo-o.": [
    { name: "Carboneum oxygenisatum", description: "Carboneum oxygenisatum" },
  ],
  "carb-s.": [
    { name: "Carboneum sulphuratum", description: "Carboneum sulphuratum" },
  ],
  "carb-v.": [{ name: "Carbo vegetabilis", description: "Carbo vegetabilis" }],

  "card-b.": [
    { name: "Carduus benedictus", description: "Carduus benedictus" },
  ],
  ...
  "caul.": [
    {
      ...
      description: "Caulophyllum thalictroides",
    },
  ],
  "caust.": [{ name: "Causticum", description: "Causticum" }],
  "cean.": [
    { name: "Ceanothus americanus", description: "Ceanothus americanus" },
  ],
  "cedr.": [{ name: "Cedron", description: "Cedron" }],
  "cench.": [
    { name: "Cenchris contortrix", description: "Cenchris contortrix" },
  ],
  ...
  "cet.": [
    { name: "Cetrararia islandica", description: "Cetrararia islandica" },
  ],
  ...
  "chen.": [
    {
      name: "Chenopodium glauci aphis",
      description: "Chenopodium glauci aphis",
    },
  ],
  "chen-a.": [
    {
      name: "Chenopodium anthelminticum",
      description: "Chenopodium anthelminticum",
    },
  ],
  "chen-v.": [
    { name: "Chenopodium vulvaria", description: "Chenopodium vulvaria" },
  ],

  "chim.": [
    { name: "Chimaphila umbellata", description: "Chimaphila umbellata" },
  ],
  "chim-m.": [
    { name: "Chimaphila maculata", description: "Chimaphila maculata" },
  ],
  "chin.": [{ name: "China officinalis", description: "China officinalis" }],
  "chin-a.": [
    { name: "Chininum arsenicosum", description: "Chininum arsenicosum" },
  ],
  "chin-b.": [{ name: "Chininum brom", description: "Chininum brom" }],
  "chin-s.": [
    { name: "Chininum sulphuricum", description: "Chininum sulphuricum" },
  ],
  "chion.": [
    { name: "Chionanthus virginica", description: "Chionanthus virginica" },
  ],
  ...
  "chr-ox.": [
    { name: "Chromicum oxydatum", description: "Chromicum oxydatum" },
  ],
  ...
  "cimic.": [
    {
      name: "Cimicifuga racemosa (Actaea Racemosa)",
      description:
        "Spasms: hysterical of epileptic; reflex from uterine disease; worse during menses; chorea agg. left side",
    },
  ],
  ...
  "ham.": [
    {
      name: "Traumatic conjunctivitis; suggillations, or extravasations into chambers of eye; from severe coughing intense soreness (Arn., Calen, Led.)",
      description:
        "Traumatic conjunctivitis; suggillations, or extravasations into chambers of eye; from severe coughing intense soreness (Arn., Calen, Led.)",
    },
  ],
  "cinch.": [
    { name: "Cinchonium sulphuricum", description: "Cinchonium sulphuricum" },
  ],
  "cinch-b.": [
    { name: "Cinchona boliviana", description: "Cinchona boliviana" },
  ],
  "cinnb.": [{ name: "Cinnabaris", description: "Cinnabaris" }],
  "cinnm.": [{ name: "Cinnamomum", description: "Cinnamomum" }],
  "cine-m.": [
    { name: "Cineraria Maritima", description: "Cineraria Maritima" },
  ],
  ...
  "cocaine.": [
    { name: "Cocainum muriaticum", description: "Cocainum muriaticum" },
  ],
  "cocc.": [{ name: "Cocculus indicus", description: "Cocculus indicus" }],
  "cocc-s.": [
    {
      name: "Coccinella septempunctata",
      description: "Coccinella septempunctata",
    },
  ],
  "coc-c.": [{ name: "Coccus cacti", description: "Coccus cacti" }],
  "coch.": [
    { name: "Cochlearia armoracia", description: "Cochlearia armoracia" },
  ],
  ...
  "colch.": [
    { name: "Colchicum autumnale", description: "Colchicum autumnale" },
  ],
  "coll.": [
    { name: "Collinsonia canadensis", description: "Collinsonia canadensis" },
  ],
  ...
  "conv.": [
    { name: "Convallaria majalis", description: "Convallaria majalis" },
  ],
  "conv-d.": [
    { name: "Convolvulus duartinus", description: "Convolvulus duartinus" },
  ],

  "cop.": [{ name: "Copaiva officinalis", description: "Copaiva officinalis" }],
  "cor-r.": [{ name: "Corallium rubrum", description: "Corallium rubrum" }],
  "cori-r.": [
    { name: "Coriaria ruscifolia", description: "Coriaria ruscifolia" },
  ],
  ...
  "crot-c.": [
    { name: "Crotalus cascavella", description: "Crotalus cascavella" },
  ],
  ...
  "cupr.": [
    {
      ...
      description:
        "Epilepsy: aura begins in knees and ascends; agg. at night during sleep (Bufo); about new moon, at regular intervals (menses); from a fall or blow upon the head; from getting wet",
    },
  ],
  "cupr-a.": [{ name: "Cuprum aceticum", description: "Cuprum aceticum" }],
  "cupr-ar.": [
    { name: "Cuprum arsenicosum", description: "Cuprum arsenicosum" },
  ],
  "cupr-n.": [{ name: "Cuprum nitricum", description: "Cuprum nitricum" }],
  "cupr-s.": [
    { name: "Cuprum sulphuricum", description: "Cuprum sulphuricum" },
  ],

  "cur.": [{ name: "Curare", description: "Curare" }],
  "cycl.": [{ name: "Cyclamen europæum", description: "Cyclamen europæum" }],
  "cypr.": [
    { name: "Cypripedium pubescens", description: "Cypripedium pubescens" },
  ],
  ...
  "euphr.": [
    {
      ...
      description:
        "Pertussis: excessive lachrymation during cough; cough only in day time (Ferr., Nat-m.)",
    },
  ],
  "eupi.": [{ name: "Eupion", description: "Eupion" }],
  "fago.": [{ name: "Fagopyrum", description: "Fagopyrum" }],
  "ferr-ar.": [
    { name: "Ferrum arsenicosum", description: "Ferrum arsenicosum" },
  ],
  "ferr.": [
    {
  ...
  "ferr-s.": [
    { name: "Ferrum sulphuricum", description: "Ferrum sulphuricum" },
  ],
  ...
  "hep.": [
    {
      ...
      description:
        "breathing, anxious, wheezing, rattling; short, deep breathing threatens suffocation; must bend head back and sit up; after suppressed eruption (Psor.)",
    },
  ],
  ...
  "jac.": [{ name: "Jacaranda gualandai", description: "Jacaranda gualandai" }],
  ...
  "kali-br.": [
    {
      name: "Kali bromatum",
      description: `Spasms: from fright, anger or emotional causes in nervous plethoric persons; during parturition, teething, whooping - cough, Bright's disease.`,
    },
  ],
  ...
  "kali-fer.": [
    { name: "Kali ferrocyanicum", description: "Kali ferrocyanicum" },
  ],
  ...
  "lith-m.": [
    { name: "Lithium muriaticum", description: "Lithium muriaticum" },
  ],
  ...
  "mag-p-a.": [
    { name: "Magnetis poli ambo", description: "Magnetis poli ambo" },
  ],
  "mag-s.": [
  ...
  "merc-ac.": [
    { name: "Mercurius aceticus", description: "Mercurius aceticus" },
  ],
  "merc-c.": [
    {
  ...
  "merc-cy.": [
    { name: "Mercurius cyanatus", description: "Mercurius cyanatus" },
  ],
  ...
  "merc-n.": [
    { name: "Mercurius nitrosus", description: "Mercurius nitrosus" },
  ],
  "merc-p-r.": [
    {
  ...
  "nat-caco.": [
    { name: "Natrum Cacodilinum", description: "Natrum Cacodilinum" },
  ],
  "nat-h.": [
    {
  ...
  "pop.": [{ name: "Populus tremuloides", description: "Populus tremuloides" }],
  ...
  "rhus-t.": [
    { name: "Rhus toxicodendron", description: "Rhus toxicodendron" },
  ],
  "rhus-v.": [{ name: "Rhus venenata", description: "Rhus venenata" }],
  "ric.": [{ name: "Ricinus Communis", description: "Ricinus Communis" }],
  "rob.": [{ name: "Robinia pseudacacia", description: "Robinia pseudacacia" }],
  ...
  "sal-ac.": [
    { name: "Salicylicum acidum", description: "Salicylicum acidum" },
  ],
  ...
  "Bac-Gaert.": [
    {
      name: "dsafas",
      description:
        "The keynote for this nosode is malnutrition and as this would imply, it is the nosode applicable to the treatment of many diseases of childhood, but it is also found to be of value in the other extreme of life associated with malignancy.",
    },
  ],
  "sang-n.": [
  ...
  testing: [
    {
      name: "abandoned",
      description:
        "ABANDONED- these is the testing data under abandoned rubrics to test the functionality working properly or not",
    },
    {
      name: "abrupt",
      description:
        "ABRUPT- these is under abrupt helo world structuring balbal alnakcnaslsamscascasck",
    },
  ],
  ...
  "sul-ac.": [
    { name: "Sulphuricum acidum", description: "Sulphuricum acidum" },
  ],
  ...
  "tarent-c.": [
    { name: "Tarentula cubensis", description: "Tarentula cubensis" },
  ],
  ...
  "trif-p.": [
    { name: "Trifolium pratense", description: "Trifolium pratense" },
  ],
  ...
  "wye.": [{ name: "Wyethia helenioides", description: "Wyethia helenioides" }],
  "xan.": [
    {
  ...
  "zinc-s.": [
    { name: "Zincum sulphuricum", description: "Zincum sulphuricum" },
  ],
  "zing.": [{ name: "Zingiber", description: "Zingiber" }],
  "ziz.": [{ name: "Zizia aurea", description: "Zizia aurea" }],
  "bac.": [
    {
      name: "In fat scrofulous children, Calc. 6, 6h. Intercurrently, Bac 30, once a week.",
      description:
        "In fat scrofulous children, Calc. 6, 6h. Intercurrently, Bac 30, once a week.",
    },
  ],
  "sil.": [
    {
      name: "In thin, rickety children, Sil. 6, 6h. Intercurrently, Bac. 30, once a week.",
      description:
        "In thin, rickety children, Sil. 6, 6h. Intercurrently, Bac. 30, once a week.",
    },
  ],
  "cin.": [
    {
      name: "When due to worms, Cina 3, 6h.",
      description: "When due to worms, Cina 3, 6h.",
    },
  ],
  "lyc.": [
    {
      name: "If due to flatulence with or without constipation, Lyc. 6, 6hrly ",
      description:
        "If due to flatulence with or without constipation, Lyc. 6, 6hrly ",
    },
  ],
  "dios.": [
    {
      name: "If from flatulence, with great pain, the bowels being open or loose, Dios. 12, 6h.",
      description:
        "If from flatulence, with great pain, the bowels being open or loose, Dios. 12, 6h.",
    },
  ],
  "ign.": [
    {
      name: "Hysterical distension, (1) Ign. 12, 2h. (2) Asaf. 12, 2h.",
      description: "Hysterical distension, (1) Ign. 12, 2h. (2) Asaf. 12, 2h.",
    },
  ],
  "thuj.": [
    {
      name: "As if a living animal were there, Thuj. 12, 2h.",
      description: "As if a living animal were there, Thuj. 12, 2h.",
    },
  ],
};
  ...
  chapters: [
    {
      ...
      rubrics: [
        ...
        },
        {
          ...
          meaning:
            "[Absentmindedness simply means having or showing forgetful or inattentive behaviour.]",
          notes: [
            {
              type: "system",
        ...
        },
        {
          ...
          meaning:
            "Absorbed means something or someone that is taking the attention totally",
          notes: [
            {
              type: "system",
        ...
        },
        {
          ...
          meaning:
            "Absorbed means something or someone that is taking the attention totally, Frivolity means taking for granted or not serious in doing something",
          notes: [],
        },
        {
    ...
    },
    {
      ...
      rubrics: [
        ...
        },
        {
          ...
          notes: [{ type: "Investigation", text: "Boericke (52)" }],
        },
        {
          id: "rubric_17",
        ...
        },
        {
          ...
          remedies: [{ abbr: "ferr-p", grade: 1 }],
          notes: [],
        },
        {
          id: "rubric_38",
          name: "Clinical; Clarke; Albuminuria (1)",
          remedies: [{ abbr: "merc-c", grade: 1 }],
          notes: [],
        },
        {
          id: "rubric_39",
        ...
        },
        {
          ...
          remedies: [{ abbr: "vinc-m", grade: 1 }],
          notes: [],
        },
        {
          id: "rubric_48",
          name: "Clinical; Boericke; Alopecia; Chronic (1)",
          remedies: [{ abbr: "fl-ac", grade: 1 }],
          notes: [],
        },
        {
          id: "rubric_49",
      ...
      rubrics: [
        {
          ...
          remedies: [{ abbr: "Ars-h.", grade: 1 }],
          notes: [],
        },
        {
          id: "prod_2",
          name: "Anguish",
          remedies: [{ abbr: "Chin.", grade: 1 }],
          notes: [],
        },
        {
          id: "prod_3",
          name: "Anticipation of any unusual ordeal may hasten chill",
          remedies: [{ abbr: "Gels.", grade: 1 }],
          notes: [],
        },
        {
          id: "prod_4",
        ...
        },
        {
          ...
          remedies: [{ abbr: "Lac. c.", grade: 1 }],
          notes: [],
        },
        {
          id: "prod_10",
          name: "Bilious; symptoms strongly marked",
          remedies: [{ abbr: "Podo.", grade: 3 }],
          notes: [],
        },
        {
          id: "prod_11",
...
export const Homeosetu_Bowel_Nosode_repertory: KentRepertory = {
  bookName:
    "Homeosetu Repertory To Keynotes and Characteristics of MM By Allen",
  chapters: [
    {
      id: "ak_ch_mind",
      name: "Mind",
...
REPERTORY_BOOKS.push(
  KENT_REPERTORY,
  Homeosetu_Clinical_Repertory,
  HOMEOSETU_ALLEN,
  Allen_Fever_Repertory,
  Homeosetu_Bowel_Nosode_repertory,
);

export function getRemedyFullName(abbr: string, name?: string): string {
