      ...
      <div className="container mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4 text-base sm:text-lg">
            ...
            <strong>Professional</strong> & you need help in any of your cases, 
            join our mentorship program - <strong>Shishya Margdarshan</strong> & 
            Dr. Alpesh Oza will guide you.
          </p>
